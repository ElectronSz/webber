...
*/ (function (e, t) {
    var n,
        ...
        H = function (e) {
            (o.addEventListener || "load" === e.type ||
                "complete" === o.readyState) && (q(), b.ready());
        },
        q = function () {
            o.addEventListener
    ...
    b.fn = b.prototype = {
        ...
        init: function (e, n, r) {
            ...
            if ("string" == typeof e) {
                if (
                    i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) &&
                            e.length >= 3
                        ? [null, e, null]
                        : N.exec(e), !i || !i[1] && n
                ) {
        ...
        b.extend({
            ...
            isPlainObject: function (e) {
                if (
                    !e || "object" !== b.type(e) || e.nodeType || b.isWindow(e)
                ) return !1;
                try {
                    if (
                        e.constructor && !y.call(e, "constructor") &&
    ...
    b.fn.extend({
        ...
        hasClass: function (e) {
            ...
            for (; r > n; n++) {
                if (
                    1 === this[n].nodeType &&
                    (" " + this[n].className + " ").replace(X, " ").indexOf(
                            t,
                        ) >= 0
                ) return !0;
            }
    ...
    b.event = {
                ...
                while (l--) {
                    s = rt.exec(n[l]) || [],
                        ...
                        d = b.extend({
                            ...
                            selector: a,
                            needsContext: a &&
                                b.expr.match.needsContext.test(a),
                            namespace: m.join("."),
                        }, c),
                        (h = u[g]) ||
                        (h = u[g] = [],
                ...
                if (
                    n.type = g,
                        !(a || n.isDefaultPrevented() ||
                            ...
                            !b.acceptData(i) || !u || !i[g] || b.isWindow(i))
                ) {
                ...
                while ((o = s[n++]) && !e.isPropagationStopped()) {
                    ...
                    while (
                        ...
                        (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
                            (e.handleObj = i,
                                e.data = i.data,
                                r = ((b.event.special[i.origType] || {})
                                    .handle || i.handler).apply(o.elem, u),
                                r !== t && (e.result = r) === !1 &&
        ...
        handlers: function (e, n) {
            ...
            return n.length > u && s.push({ elem: this, handlers: n.slice(u) }),
                s;
        },
        fix: function (e) {
                ...
                ? (e && e.type
                    ? (this.originalEvent = e,
                        ...
                        this.isDefaultPrevented =
                            e.defaultPrevented || e.returnValue === !1 ||
        ...
        function (e, t) {
                ...
                if (!d && !r) {
                    if (i = J.exec(e)) {
                        if (a = i[1]) {
                            if (9 === s) {
                                if (
                                    o = t.getElementById(a), !o || !o.parentNode
                                ) return n;
                    ...
                    return n !== p && 9 === n.nodeType && n.documentElement
                        ? (p = n,
                            ...
                            i.find.CLASS = T.getByClassName && function (e, n) {
                                return typeof n.getElementsByClassName === A ||
                                        d
                                    ? t
                            ...
                            (T.matchesSelector = rt(
                                m = f.matchesSelector || f.mozMatchesSelector ||
                ...
                st.matchesSelector = function (e, t) {
                    if (
                        (e.ownerDocument || e) !== p && c(e),
                            t = t.replace(Z, "='$1']"),
                            !(!T.matchesSelector || d || g && g.test(t) ||
                                h.test(t))
                    ) {
                        try {
                            var n = m.call(e, t);
                            if (
                                n || T.disconnectedMatch ||
            ...
            function wt(e, t, n, r) {
                ...
                if (!r && 1 === p.length) {
                    if (
                        a = p[0] = p[0].slice(0),
                            a.length > 2 && "ID" === (u = a[0]).type &&
                            9 === t.nodeType && !d && i.relative[a[1].type]
                    ) {
                        if (
                ...
                if (
                    ...
                    if (a) {
                        for (
                            ...
                            o = s[c],
                                kt.test(o.type || "") &&
                                !b._data(o, "globalEval") && b.contains(u, o) &&
                                (o.src
                                    ? b.ajax({
                                        url: o.src,
                                        type: "GET",
        ...
        if (1 === t.nodeType) {
            ...
            "script" === n && t.text !== e.text
                ...
                ? (t.parentNode && (t.outerHTML = e.outerHTML),
                    b.support.html5Clone && e.innerHTML &&
    ...
    function Ot(e, n) {
        ...
        if (!s) {
            for (
                s = [], r = e.childNodes || e; null != (o = r[a]); a++
    ...
    b.extend({
        clone: function (e, t, n) {
            ...
            if (
                b.support.html5Clone || b.isXMLDoc(e) ||
                    !mt.test("<" + e.nodeName + ">")
                    ? o = e.cloneNode(!0)
                    : (Dt.innerHTML = e.outerHTML,
                        Dt.removeChild(o = Dt.firstChild)),
                    !(b.support.noCloneEvent && b.support.noCloneChecked ||
                        1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e))
            ) {
                for (
                    r = Ot(o), s = Ot(e), a = 0; null != (i = s[a]); ++a
                ) r[a] && Ft(i, r[a]);
            }
            if (t) {
                if (n) {
                ...
                if (o = e[h], o || 0 === o) {
                    if ("object" === b.type(o)) {
                        ...
                        s = s || f.appendChild(t.createElement("div")),
                            ...
                            c = At[u] || At._default,
                            s.innerHTML = c[1] + o.replace(vt, "<$1></$2>") +
                                c[2],
                            i = c[0];
                        while (i--) {
                            s = s.lastChild;
                        ...
                        if (
                            !b.support.leadingWhitespace && yt.test(o) &&
                            ...
                            while (
                                ...
                                b.nodeName(l = o.childNodes[i], "tbody") &&
                                    !l.childNodes.length && o.removeChild(l);
                            }
                        }
    ...
    b.each(["height", "width"], function (e, n) {
        ...
        b(function () {
            ...
            (b.cssHooks.marginRight = {
                ...
                !b.support.pixelPosition && b.fn.position &&
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                return this.name && !b(this).is(":disabled") &&
                    hn.test(this.nodeName) && !dn.test(e) &&
            ...
            var r,
                ...
                o = function (e, t) {
                    t = b.isFunction(t) ? t() : null == t ? "" : t,
                        i[i.length] = encodeURIComponent(e) + "=" +
    ...
    b.fn.load = function (e, n, r) {
        ...
        return u >= 0 && (i = e.slice(u, e.length), e = e.slice(0, u)),
            ...
            s.length > 0 &&
            b.ajax({ url: e, type: a, dataType: "html", data: n }).done(
                function (e) {
                    o = arguments,
                        s.html(
                            i
            ...
            ajax: function (e, n) {
                ...
                if (
                    h.promise(N).complete = g.add,
                        N.success = N.done,
                        N.error = N.fail,
                        p.url = ((e || p.url || yn) + "").replace(xn, "")
                            .replace(kn, mn[1] + "//"),
                        p.type = n.method || n.type || p.method || p.type,
                        p.dataTypes =
                            b.trim(p.dataType || "*").toLowerCase().match(w) ||
                            [""],
                        null == p.crossDomain &&
                                    ...
                                    r[1] === mn[1] && r[2] === mn[2] &&
                                        (r[3] || ("http:" === r[1]
                                            ...
                                            (mn[3] || ("http:" === mn[1]
                                                ? 80
                                                : 443)))),
                        p.data && p.processData && "string" != typeof p.data &&
